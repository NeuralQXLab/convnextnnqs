...
srun uv --project /lustre/fsn1/projects/rech/rgs/uvm91ap/uv_envs/nk_pro_update run /lustre/fswork/projects/rech/rgs/uvm91ap/repos/netket_pro_update/deepnets/scripts/../optimization/run.py --config /lustre/fswork/projects/rech/rgs/uvm91ap/projects/deepNQS/ConvNext/03_12_24/L8_2x2_symmramp/4/config.yaml --n_blocks 4 --seed 4 --chunk_size 256
