...
#SBATCH --output=/gpfswork/rech/iqu/uvm91ap/projects/deepNQS/ConvNext/14_10_24/L=6/symm_ramp_3x3/5/%j.out
...
if [ "$recursion_number" -gt 4 ]; then
  ...
  ((recursion_number+=1))
  sbatch --export=ALL,recursion_number=$recursion_number /gpfswork/rech/iqu/uvm91ap/projects/deepNQS/ConvNext/14_10_24/L=6/symm_ramp_3x3/sbatch5.sh
 exit 0
fi
}
trap 'cleanup_function' USR1
echo "recursion $recursion_number started at $(date)"
echo pip freeze > /gpfswork/rech/iqu/uvm91ap/projects/deepNQS/ConvNext/14_10_24/L=6/symm_ramp_3x3/5/requirements.txt
pip freeze > /gpfswork/rech/iqu/uvm91ap/projects/deepNQS/ConvNext/14_10_24/L=6/symm_ramp_3x3/5/requirements.txt
