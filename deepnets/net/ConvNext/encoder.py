...
class ConvNext2BlockDoubleSkip(nn.Module):
    kernel_size: tuple
    n_features: int
    expansion_factor: int = 4
    param_dtype: DType = float
...
class EncoderDoubleSkip(nn.Module):
    """
    Encoder using the ConvNext2BlockDoubleSkip which has two skip connections rather than the standard one
    """
